...
# -*- coding: utf-8 -*-
"""
Openshift Django secret key utilities based on
...
def openshift_secure(default_keys, secure_function='make_secure_key'):
    ...
    if my_token is not None:
        ...
        sys.stderr.write("WARNING: Using default values for secure " +
                         "variables, please manually modify in " +
                         calling_file + "\n")
